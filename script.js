...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo", "aku mau nanya sama kamu?", "question").then(function () {
      ...
      Swal.fire("Don't Lie, OK!!", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} Rindu ga sama ${sender}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga Rindu banget sama ${nama}`).then(function () {
                Swal.fire({
                  title: 'Seberapa Rindu?',
                  icon: 'question',
                  input: 'range',
                  ...
                  val = e.value
                  Swal.fire(`Makasih ya udah Rindu sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Nanti ${nama} datang nggak ke ${sender}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      confirmButtonText: `Datang :(`,
                      denyButtonText: `Insya Allah`,
                    }).then((result) => {
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`kalau mau nonton jaga kesehetan  yaa!, ${sender} juga Rindu kamu, ${nama} Sukses dan sehat selalu ya kamu :((`).then(function () {
                          Swal.fire('Terakhir Kak ').then(function () {
